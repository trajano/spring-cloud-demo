 ...
 */
export type StyleProps = Omit<RN.ViewStyle, "testID" | "transformMatrix" | "rotation" | "scaleX" | "scaleY" | "translateX" | "translateY" | "shadowColor" | "shadowOffset" | "shadowOpacity" | "shadowRadius"> & {
    /**
