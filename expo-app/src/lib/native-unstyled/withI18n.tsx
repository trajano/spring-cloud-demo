...
import {
    Animated, Text as RNText, TextInputProps,
    TextProps
} from "react-native";
...
export function withI18n<P extends Animated.AnimatedProps<TextProps> = Animated.AnimatedProps<TextProps>>(Component: ComponentType<P>,
    {
        _tIsChild = false,
        localizedMap = {
            _a: 'accessibilityLabel',
