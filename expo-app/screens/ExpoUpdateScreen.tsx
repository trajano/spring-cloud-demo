...
import { BlurView, Text, useRefreshControl, View } from '../src/lib/native-unstyled';
...
export function ExpoUpdateScreen(): ReactElement<SectionListProps<Record<string, unknown>>, any> {
    ...
    const [sections, setSections] = useDeepState<SectionListData<any>[]>([
        ...
        {
            key: "expo-update.logEntries", data: []
        },
    ]);
