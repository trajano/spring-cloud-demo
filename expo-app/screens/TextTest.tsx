...
export function TextTest() {
    ...
    >
        ...
        <View testID="hocText">
            <Text style={{ fontFamily: "Nunito", fontSize: 32 }}>HOC Test <Text style={{ fontWeight: "bold" }}>Sub <Text style={{ fontStyle: "italic" }}>Sub-Sub</Text></Text> HOC</Text>
        </View>
        ...
        <TextInput _p='Username' defaultValue={username} onChangeText={setUsername} width={300} backgroundColor="#DDDDFF" />
